...
var TeamPaths = []PathSpec{
	...
	},
	{
		...
		Delete: &OperationSpec{
			Response:            tdproto.Team{},
			ResponseDescription: ":ref:`tdproto-Team` object of deleted team.",
	...
	},
	{
		...
		Post: &OperationSpec{
			...
			ResponseDescription: "Updated :ref:`tdproto-Contact` object.",
		},
		Delete: &OperationSpec{
			Response:            tdproto.Contact{},
			Description:         []string{"Remove contact from the team.", "Must have admin rights."},
			ResponseDescription: "Removed :ref:`tdproto-Contact` object.",
		},
	},
}
